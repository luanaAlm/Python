...
horaTrab = int(input('Quantas horas trabalhadas no mês? '))
salario = ganho * horaTrab
inpRenda = (salario * 11) / 100
inss = (salario * 8) / 100
sindicato = (salario * 5) / 100
salLiq = salario - inpRenda - inss - sindicato
print('Salário Bruto : R$ {}'.format(salario))
print('IR (11%) : R$ {}'.format(inpRenda))
print('INSS (8%) : R$ {}'.format(inss))
print('Sindicato ( 5%) : R$ {}'.format(sindicato))
print('Salário Liquido : R$ {}'.format(salLiq))
